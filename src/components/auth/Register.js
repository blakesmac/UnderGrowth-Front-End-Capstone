                    ...
                    fetch("http://localhost:8088/users", {
                        ...
                        .then(createdUser => {
                            if (createdUser.hasOwnProperty("id")) {
                                sessionStorage.setItem("undergrowth_user", createdUser.id)
                                history.push("/")
                            }
                        })
                }
        ...
        <main style={{ textAlign: "center" }}>
            ...
            <form className="form--login" onSubmit={handleRegister}>
                ...
                <fieldset>
                    ...
                    <input type="text" name="password" id="password" className="form-control" placeholder="Password" required value={registerUser.password} onChange={handleInputChange} />
                </fieldset>
                <fieldset>
